...
class DepositAccountLite extends SdkObject
{
    ...
    {
        return Spec::fromJson('{"rules": [], "type": "object", "schema": {"name": {"rules": ["required"], "type": "string"}, "uuid": {"rules": ["required"], "type": "uuid"}, "type": {"rules": ["in:bank,bitcoin", "required"], "type": "string"}}}');
    }
