...
class GetPaymentOrdersQueryParams extends SdkObject
{
    ...
    {
        return Spec::fromJson('{"rules": ["nullable"], "type": "object", "schema": {"page": {"rules": ["nullable", "min:0"], "type": "integer"}, "status": {"rules": ["in:pending,partial,mempool_unconfirmed,unconfirmed,paid,cancelled,expired,network_dispute,mempool_network_dispute,possible_chargeback,chargeback"], "type": "string"}, "sort_by": {"rules": ["in:amount,created_at", "nullable"], "type": "string"}, "page_size": {"rules": ["nullable", "max:40"], "type": "integer"}, "sort_order": {"rules": ["in:asc,desc", "nullable"], "type": "string"}}}');
    }
