...
class PaymentOrderCreation extends SdkObject
{
    ...
    {
        return Spec::fromJson('{"rules": [], "type": "object", "schema": {"callback_url": {"rules": ["regex[https_url]:^https://", "nullable", "maxlen:300"], "type": "url"}, "reference": {"rules": ["maxlen:300", "nullable"], "type": "string"}, "cancel_url": {"rules": ["regex[https_url]:^https://", "nullable", "maxlen:300"], "type": "url"}, "required_confirmations": {"rules": ["min:0", "nullable"], "type": "integer"}, "amount": {"rules": ["required", "decimal"], "type": "string"}, "continue_url": {"rules": ["regex[https_url]:^https://", "nullable", "maxlen:300"], "type": "url"}, "details": {"rules": ["maxlen:300", "nullable"], "type": "string"}}}');
    }
