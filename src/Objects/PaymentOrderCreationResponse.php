...
class PaymentOrderCreationResponse extends SdkObject
{
    ...
    {
        return Spec::fromJson('{"rules": [], "type": "object", "schema": {"redirect_url": {"rules": ["regex[https_url]:^https://", "required", "nullable"], "type": "url"}, "uuid": {"rules": ["required"], "type": "uuid"}, "created_at": {"rules": ["nullable"], "type": "ISO_8601_date"}, "reference": {"rules": ["nullable"], "type": "string"}}}');
    }
